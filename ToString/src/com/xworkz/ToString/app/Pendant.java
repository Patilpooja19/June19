...
public class Pendant {
		...
		public String toString() {
			return "Material:" + this.material + "Design:" + this.design + "Shape:" + this.shape + "attachement:" + this.attachement + "Gemstones:" + this.gemstones + "Symbolism:" + this.symbolism + "chaintype:"
					+ this.chaintype + "Occasion:" + this.occasion + "Setting:" + this.setting + "Colour:" + this.color + "Bail:" + this.bail + "Cultural Influence:" + this.culturalInfluence;
		}
